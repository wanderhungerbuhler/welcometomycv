...
export type LessonCreateInput = {
  /** availableAt input for default locale (en) */
  ...
  title: Scalars['String'];
  updatedAt?: InputMaybe<Scalars['DateTime']>;
  /** videoId input for default locale (en) */
...
export type ScheduledOperationAffectedDocument = Asset | Lesson | Teacher;
...
export type GetLessonBySlugQuery = { __typename?: 'Query', lesson?: { __typename?: 'Lesson', title: string, videoId?: string | null, availableAt?: any | null, description?: string | null, teacher?: { __typename?: 'Teacher', bio: string, avatarURL: string, name: string } | null } | null };
